...
<!-- Exponential stuff looks bad right now, let me figure out how to fix it later -- AW -->

<!-- ```{r expplots, results='asis',fig.cap=captions, dpi=300, fig.height=4, fig.width=6} -->
...
for (dist in dists[-1]) ## think exponential is wonky -- will try to fix AW ## 
{

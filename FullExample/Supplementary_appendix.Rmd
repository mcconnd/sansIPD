...
<!--   cat('\n\n')  -->
<!--   print(knitr::kable( -->
<!--     list(is.models[[dist]]$post_cov,is.models[[dist]][["orig"]]$cov), --><!--     caption=paste0("Covariance matrices obtained using trial data only (left) and combining trial data with external information (right): ",distributions[dist], " distribution."))) -->
<!-- cat('\n\n')  -->
<!--   plots<-readRDS(paste0("./output/plots_",dist)) -->
